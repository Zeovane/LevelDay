      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white p-3 border-t border-gray-200">
        <div className="flex gap-2">
          <textarea
            ...
            className="flex-1 text-lg text-gray-800 bg-gray-100 border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-[#1eae89] resize-none"
      ...
      {selectedAnnotation && (
        <div className="fixed inset-0 bg-black bg-opacity-60 z-40 flex justify-center items-center p-4">
          <div className="bg-white text-gray-800 rounded-lg shadow-xl w-full max-w-sm p-5 flex flex-col gap-4" onClick={(e) => e.stopPropagation()}>
            {/* Header */}
            <div className="relative bg-[#f08436] text-white -m-5 mb-0 rounded-t-lg p-4 h-16 flex items-center">
              <input
                type="text"
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div>
                <label className="text-xs uppercase tracking-wider text-gray-500">Data</label>
                <div className="flex gap-2 mt-1">
                  <input
                    ...
                    maxLength={2}
                    className="w-full h-10 text-center bg-gray-100 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1eae89]"
                  />
                  <input
                    type="text"
                    placeholder="MM"
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  <input
                    ...
                    className="w-full h-10 px-1 text-center bg-gray-100 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1eae89]"
                  />
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full h-20 bg-gray-100 text-gray-800 rounded-md mt-1 p-2 focus:outline-none focus:ring-2 focus:ring-[#1eae89] resize-none"
            ...
            {/* Priority */}
            <div>
              <label className="text-xs uppercase tracking-wider text-gray-500">Ranking de prioridade</label>
